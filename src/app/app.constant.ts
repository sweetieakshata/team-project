...
export const AppConstant = Object.freeze({
  ...
  API_ENDPOINT1: 'https://46a6590c.ngrok.io/api/Settings/',
  API_ENDPOINT2: 'https://46a6590c.ngrok.io/api/Member/',
  ...
  API_CONFIG: {
    ...
    API_URL: {
      ...
      SETTINGS: {
        ...
        // INSERTDOCUMENT:'InsertUpdateLocation',
        DELETELOCATION:'DeleteLocation/?LocationId=',



        // GETDEPARTMENT: 'Getlocations',
        // INSERTDEPARTMENT:'InsertUpdateDepartment',
        // DELETEDEPARTMENT:'DeleteLocation/?DepartmentId='

         GETUSER: 'GetOrganizationMember/?organizationid=1&',
         GETUSERSEARCH:'GetOrganizationMember/?searchstring=',
